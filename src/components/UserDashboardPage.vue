        ...
        height="350"
          ...
          >
            ...
            <v-card-text>
              ...
              <v-btn color="blue" @click="detailsDialog = true">Show details</v-btn>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-col>
            ...
            <v-row dense>
              ...
              <v-col cols="12" md="4" sm="6">
                ...
                <v-card-actions>
                  ...
                  variant="tonal"
                  color="blue"
                  @click.stop="$emit('modal-close')">Save</v-btn>
                  <!-- Cancel button -->
                  <v-btn
                  color="red"
                  variant="plain"
                  prepend-icon="mdi-close"
                  @click.stop="$emit('modal-close')">Cancel</v-btn>
                </v-card-actions>
  ...
  <!-- Quiz Details Modal -->
      <v-dialog v-model="detailsDialog" max-width="800px">
        <v-card>
          ...
          <v-card-actions>
            <v-btn color="blue" @click="editDialog = false">Close</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </v-row>
